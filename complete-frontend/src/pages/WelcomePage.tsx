    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="size-12 bg-blue-600 rounded-xl flex items-center justify-center">
              <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-8 text-white">
                <path
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to HealthAI</h1>
          <p className="text-gray-600 text-lg">Sign in to access your health portal</p>
        </div>
        ...
        >
          ...
          <div className="mb-8">
            <fieldset>
              ...
              <div className="space-y-3">
                <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 focus-within:bg-blue-50 focus-within:border-blue-500 transition-all duration-200">
                  <input
                    type="radio"
                    name="role"
                    value="patient"
                  ...
                  <div>
                    ...
                    <div id="patient-description" className="text-sm text-gray-500">
                ...
                <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 focus-within:bg-blue-50 focus-within:border-blue-500 transition-all duration-200">
                  ...
                  <div>
                    ...
                    <div id="clinician-description" className="text-sm text-gray-500">
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold text-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
